...
; (function () {
  ...
  style.textContent = [
    ...
    '  --jh-fade-color: rgba(7, 16, 33, 0.58);',
    '}',
    '',
    '.jh-header-top {',
    '  position: relative;',
    ...
    '  height: 56px;',
    '  pointer-events: none;',
    '  background: linear-gradient(to bottom, var(--jh-fade-color) 0%, rgba(0, 0, 0, 0) 100%);',
    '}',
    '',
    ...
    '.jh-home-header { --jh-fade-color: rgba(214, 214, 214, 0.58); }',
    '.jh-archives-header.jh-scrolled { background: rgba(0, 0, 0, 0.78) !important; }',
    '.jh-archives-header { --jh-fade-color: rgba(0, 0, 0, 0.78); }',
    ...
    '.jh-darkroom-header { --jh-fade-color: rgba(24, 17, 11, 0.82); }',
